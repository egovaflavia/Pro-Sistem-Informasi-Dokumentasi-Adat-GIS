...
Route::group([
    ...
    Route::group([
        ...
        Route::get('edit/{berita_id}', [KerajinanController::class, 'edit'])->name('edit');
        Route::post('store', [KerajinanController::class, 'store'])->name('store');
        Route::put('update', [KerajinanController::class, 'update'])->name('update');
        Route::get('destroy/{berita_id}', [KerajinanController::class, 'destroy'])->name('destroy');
    });
    ...
    Route::group([
        ...
        Route::get('edit/{berita_id}', [KesenianController::class, 'edit'])->name('edit');
        Route::post('store', [KesenianController::class, 'store'])->name('store');
        Route::put('update', [KesenianController::class, 'update'])->name('update');
        Route::get('destroy/{berita_id}', [KesenianController::class, 'destroy'])->name('destroy');
    });
    ...
    Route::group([
        ...
        Route::get('edit/{berita_id}', [PerhelatanController::class, 'edit'])->name('edit');
        ...
        Route::get('destroy/{berita_id}', [PerhelatanController::class, 'destroy'])->name('destroy');
    });
    ...
    Route::group([
        ...
        Route::get('edit/{berita_id}', [PepatahController::class, 'edit'])->name('edit');
