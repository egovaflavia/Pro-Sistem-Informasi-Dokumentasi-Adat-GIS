...
<section class="section">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form action="{{ route('backend.kesenian.update') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="kesenian_id" value="{{ $row->kesenian_id }}">
                        <div class="modal-body">
                            <label>Nama Makanan: </label>
                            <div class="form-group">
                                <input type="text" name="kesenian_nama" id="kesenian_nama" placeholder="Judul Berita"
                                    class="form-control" value="{{ old('kesenian_nama') ?? $row->kesenian_nama }}">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            <input type="text" name="kesenian_lat" id="kesenian_lat" class="form-control"
                                                value="{{ old('kesenian_lat') ?? $row->kesenian_lat }}">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            <input type="text" name="kesenian_long" id="kesenian_long"
                                                class="form-control"
                                                value="{{ old('kesenian_long') ?? $row->kesenian_long }}">
                                        </div>
                                ...
                                <div class="form-group position-relative has-icon-right">
                                    ...
                                    <div class="form-control-icon">
                                        <img style="height: 30px;width: 30px"
                                            src="{{ asset('storage/kesenian/'. $row->kesenian_img) }}" alt="No img">
                                    </div>
                                </div>
                            </div>
                            <label>Keterangan : </label>
                            <div class="form-group">
                                <textarea name="kesenian_ket"
                                    id="editor">{{ old('kesenian_ket') ?? $row->kesenian_ket }}</textarea>
